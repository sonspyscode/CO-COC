...
@InitiatingFlow(protocol = "finalize-casereport-protocol")
class FinalizeCaseReportSubFlow(private val signedTransaction: UtxoSignedTransaction, private val parties: List<MemberX500Name>): SubFlow<String> {
    ...
    override fun call(): String {
        ...
        log.info("FinalizeCaseReportFlow.call() called")
...
@InitiatedBy(protocol = "finalize-casereport-protocol")
class FinalizeCaseReportResponderFlow: ResponderFlow {
    ...
    override fun call(session: FlowSession) {
        ...
        log.info("FinalizeCaseReportResponderFlow.call() called")
        ...
        try {
            ...
            val finalizedSignedTransaction = ledgerService.receiveFinality(session) { ledgerTransaction ->
                ...
                val state = ledgerTransaction.getOutputStates(CaseReportState::class.java).singleOrNull() ?:
